...
Game.registerMod('fractylCookie',{
  ...
  createUpgrades:function() {
    ...
    //Caramethyst
		...
		this.addTieredUpgrade("Family reunion","<q>Getting all the grandmothers together for a little while keeps them happy. Just make sure not to leave them alone for too long. Before you know it, the friendly gossip becomes nefarious plotting, and soon you've got a grandmotherly revolt on your hands.</q>","Grandma",17,202,[1,5,this.icons])
		...
		this.addTieredUpgrade("Stronger materials","<q>Turns out all this warping of spacetime and whatnot is pretty damaging to the shipments. Perhaps fortifying them a little more would result in less cookies being lost in space for eternity.</q>","Shipment",17,602,[5,5,this.icons])
		this.addTieredUpgrade("Abstract alchemy","<q>It seems you've recently gained the ability to use alchemy to synthesize abstract concepts. Now you can turn gold into joy, or melancholy, or even love. Obviously, the production of cookies takes precedence, but who knows what this discovery could bring?</q>","Alchemy lab",17,702,[6,5,this.icons])

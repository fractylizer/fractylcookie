...
Game.registerMod('elessclessmless',{
  ...
  createAchievements: function(){
    ...
    this.achievements.push(new Game.Achievement("Short-lived diet", "Unlock the <b>Garden</b>. <q>No need to get your hands dirty! Those hornets must be starving!</q>",[4,18, "img/gardenPlants.png"]))
